# EasySave 1.0 - Technical Support Documentation
...
**Format**: JSON
**Purpose**: Application settings (language)
**Structure**:
```json
{
...
### state.json
**Location**: `%AppData%\ProSoft\EasySave\state.json`
**Format**: JSON
...
{
  "Name": "Documents Backup",
  "LastActionTimestamp": "2026-02-05 14:30:25",
...
### Daily Log Files
**Location**: `%AppData%\ProSoft\EasySave\Logs\YYYY-MM-DD.json`
